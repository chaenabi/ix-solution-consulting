package ix.solution.consulting.unit.filter;

import ix.solution.consulting.config.security.filter.JwtAuthenticationFilter;
...
public class JwtAuthenticationFilterTest {
    ...
    public void givenThrowAuthenticationException_whenDoFilterInternal_thenSecurityContextInContextHolderIsNullAndClearContextBeenCalled() throws ServletException, IOException {
        ...
        when(mockAuthenticationManager.authenticate(token)).thenThrow(new RuntimeException("time expired"));
