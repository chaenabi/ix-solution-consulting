...
!(function (e, t, n) {
  ...
  function g(e, t, o, i) {
    ...
    for (
      var f, d, p, m, h, g = ['modernizr', 'tspan', 'samp'];
      !R.style && g.length;
  ...
  ;(S.prefixedCSSValue = L),
    Modernizr.addTest('webanimations', 'animate' in l('div')),
  ...
  S.mq = j
  var M = ((S.testStyles = d), { elem: l('modernizr') })
  Modernizr._q.push(function () {
    delete M.elem
  })
  var R = { style: M.elem.style }
  ...
  var F = (S.prefixed = function (e, t, n) {
    return 0 === e.indexOf('@')
      ? N(e)
      : (-1 != e.indexOf('-') && (e = u(e)), t ? y(e, t, n) : y(e, 'pfx'))
  })
  ...
  ;(S.testAllProps = A),
    Modernizr.addTest('flexbox', A('flexBasis', '1px', !0)),
