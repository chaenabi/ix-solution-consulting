 ...
 * @since 0.0.1 dev
 */
public class InvalidMemberParameterException extends InvalidParameterException {
    public InvalidMemberParameterException(Errors errors, ErrorCode errorCode) {
