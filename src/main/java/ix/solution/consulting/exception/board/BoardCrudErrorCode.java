...
public enum BoardCrudErrorCode implements ErrorCode {
    ...
    MISSING_ATTACH_FILE_NAME(BAD_REQUEST, -10, ErrorMessage.MISSING_ATTACH_FILE_NAME),
    FAIL_TO_DELETE_ATTACH_FILE(INTERNAL_SERVER_ERROR, -11, ErrorMessage.FAIL_TO_DELETE_ATTACH_FILE),
    POST_AUTHOR_NOT_MATCH(UNAUTHORIZED, -12, ErrorMessage.POST_AUTHOR_NOT_MATCH),
    POST_CATEGORY_NAME_IS_NULL(BAD_REQUEST, -13, ErrorMessage.POST_CATEGORY_NAME_IS_NULL),
    POST_CATEGORY_NAME_IS_EMPTY(BAD_REQUEST, -14, ErrorMessage.POST_CATEGORY_NAME_IS_EMPTY);
